package org.firstinspires.ftc.teamcode.OldOpModes.drive;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 11.33347; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -2.1653; // in; offset of the lateral wheel
